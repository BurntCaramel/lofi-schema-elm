...
var _user$project$Lofi_Schema$tagTextValueIn = F2(
...
var _user$project$Lofi_Schema$hasTagIn = F2(
	function (tags, tagName) {
		return A2(_elm_lang$core$Dict$member, tagName, tags);
	});
var _user$project$Lofi_Schema$Item = F4(
	function (a, b, c, d) {
		return {name: a, kind: b, optional: c, isPrimaryKey: d};
	});
var _user$project$Lofi_Schema$Schema = F2(
	function (a, b) {
		return {collectionName: a, items: b};
	});
var _user$project$Lofi_Schema$Date = function (a) {
	return {ctor: 'Date', _0: a};
};
var _user$project$Lofi_Schema$Number = function (a) {
	return {ctor: 'Number', _0: a};
};
var _user$project$Lofi_Schema$Text = function (a) {
	return {ctor: 'Text', _0: a};
};
var _user$project$Lofi_Schema$tagsToKind = function (tags) {
	var tagText = _user$project$Lofi_Schema$tagTextValueIn(tags);
	var hasTag = _user$project$Lofi_Schema$hasTagIn(tags);
	if (hasTag('time')) {
		return _user$project$Lofi_Schema$Date(
			{
				time: true,
		...
		if (hasTag('date')) {
			...
			if (hasTag('number')) {
				var $default = A2(
					...
					tagText('default'));
				return _user$project$Lofi_Schema$Number(
				...
				return _user$project$Lofi_Schema$Text(
					{
...
var _user$project$Lofi_Schema$fromElement = function (element) {
	var _p4 = element;
	var _p5 = _p4._0.tags;
	var kind = _user$project$Lofi_Schema$tagsToKind(_p5);
	var name = A2(_elm_lang$core$String$join, '', _p4._0.texts);
	var hasTag = _user$project$Lofi_Schema$hasTagIn(_p5);
...
var _user$project$Lofi_Schema$addElements = F2(
	function (elements, schema) {
		var items = A2(_elm_lang$core$List$map, _user$project$Lofi_Schema$fromElement, elements);
...
var _user$project$Lofi_Schema_Output_MySQL$insertRowCommand = function (schema) {
...
var _user$project$Lofi_Schema_Output_MySQL$createTableCommandFold = F2(
	function (item, list) {
...
var _user$project$Lofi_Schema_Output_MySQL$createTableCommand = function (schema) {
	var tableName = _elm_community$string_extra$String_Extra$underscored(schema.collectionName);
	var fields = A2(
		_elm_lang$core$String$join,
		',\n',
		A2(
			...
			A2(
				...
				A3(
					_elm_lang$core$List$foldr,
					_user$project$Lofi_Schema_Output_MySQL$createTableCommandFold,
					{ctor: '[]'},
					schema.items))));
	return A2(
		_elm_lang$core$Basics_ops['++'],
...
var _user$project$LofiSchemaExampleHardCoded$viewSchemaItemRaw = function (item) {
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html$text(
						_elm_lang$core$Basics$toString(item.kind)),
					_1: {ctor: '[]'}
				}
			}
		});
};
var _user$project$LofiSchemaExampleHardCoded$viewSchema = function (schema) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		A2(_elm_lang$core$List$map, _user$project$LofiSchemaExampleHardCoded$viewSchemaItemRaw, schema.items));
};
var _user$project$LofiSchemaExampleHardCoded$view = function (model) {
	var elements = A2(_elm_lang$core$List$map, _RoyalIcing$lofi_elm$Lofi_Parse$parseElement, model.lines);
	var schema = {
		collectionName: model.collectionName,
		items: A2(_elm_lang$core$List$map, _user$project$Lofi_Schema$fromElement, elements)
	};
	return A2(
		_elm_lang$html$Html$section,
		{
			...
			_0: _elm_lang$html$Html_Attributes$style(
				{
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'maxWidth', _1: '30em'},
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		},
			...
			_0: A2(
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('schema.lofi.design'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}),
				...
				_1: {
					...
					_0: A2(
						...
						{ctor: '[]'},
						{
							...
							_1: {
								ctor: '::',
								_0: _user$project$LofiSchemaExampleHardCoded$viewSchema(schema),
								_1: {ctor: '[]'}
							}
						}),
					_1: {
						...
						_0: A2(
							...
							{ctor: '[]'},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('MySQL'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(
										...
										{ctor: '[]'},
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text(
												_user$project$Lofi_Schema_Output_MySQL$createTableCommand(schema)),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										_0: A2(
											...
											{ctor: '[]'},
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text(
													_user$project$Lofi_Schema_Output_MySQL$insertRowCommand(schema)),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}
							...
							_0: A2(
								...
								{ctor: '[]'},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('Mongoose'),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
								...
								_0: A2(
									...
									{ctor: '[]'},
									{
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('Joi'),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
...
var _user$project$LofiSchemaExampleHardCoded$update = F2(
	function (msg, model) {
		var _p0 = msg;
		return {
			ctor: '_Tuple2',
...
var _user$project$LofiSchemaExampleHardCoded$model = {
	...
	lines: {
		...
		_1: {
			ctor: '::',
			_0: 'Middle name #optional',
			_1: {
				ctor: '::',
				_0: 'Last name #text #max: 255',
				_1: {
					ctor: '::',
					_0: 'Email #email',
					_1: {
						ctor: '::',
						_0: 'Date of birth #date',
						_1: {
							ctor: '::',
							_0: 'Last signed in at #time #now',
							_1: {
								ctor: '::',
								_0: 'Favorite number #number #default: 7',
								_1: {ctor: '[]'}
							}
						}
					}
...
var _user$project$LofiSchemaExampleHardCoded$main = _elm_lang$html$Html$program(
	{
		view: _user$project$LofiSchemaExampleHardCoded$view,
		update: _user$project$LofiSchemaExampleHardCoded$update,
		subscriptions: function (_p1) {
			return _elm_lang$core$Platform_Sub$none;
		},
		init: {ctor: '_Tuple2', _0: _user$project$LofiSchemaExampleHardCoded$model, _1: _elm_lang$core$Platform_Cmd$none}
	})();
var _user$project$LofiSchemaExampleHardCoded$Model = F2(
	function (a, b) {
		return {collectionName: a, lines: b};
	});
var _user$project$LofiSchemaExampleHardCoded$AddItem = {ctor: 'AddItem'};

var Elm = {};
Elm['LofiSchemaExampleHardCoded'] = Elm['LofiSchemaExampleHardCoded'] || {};
if (typeof _user$project$LofiSchemaExampleHardCoded$main !== 'undefined') {
    _user$project$LofiSchemaExampleHardCoded$main(Elm['LofiSchemaExampleHardCoded'], 'LofiSchemaExampleHardCoded', undefined);
}
