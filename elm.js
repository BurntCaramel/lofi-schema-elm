...
var _user$project$Lofi_Schema_Output_ReactProps$pairsToStruct = F2(
	function (name, pairs) {
...
var _user$project$Lofi_Schema_Output_ReactProps$lowerCamelCase = function (input) {
	var _p2 = _elm_lang$core$String$uncons(
		_elm_community$string_extra$String_Extra$camelize(input));
	if (_p2.ctor === 'Just') {
		return A2(
			_elm_lang$core$String$cons,
			_elm_lang$core$Char$toLower(_p2._0._0),
			_p2._0._1);
	} else {
		return '';
	}
};
var _user$project$Lofi_Schema_Output_ReactProps$createStructPropertiesCodeFold = F2(
	function (item, list) {
		...
		var propertyName = _user$project$Lofi_Schema_Output_ReactProps$lowerCamelCase(item.name);
...
var _user$project$Lofi_Schema_Output_ReactProps$createStructCode = function (schema) {
	var structCode = A2(
		_user$project$Lofi_Schema_Output_ReactProps$pairsToStruct,
		_user$project$Lofi_Schema_Output_ReactProps$lowerCamelCase(schema.collectionName),
		A2(
			_elm_lang$core$List$map,
			...
			A2(
				...
				A3(
					_elm_lang$core$List$foldr,
					_user$project$Lofi_Schema_Output_ReactProps$createStructPropertiesCodeFold,
					{ctor: '[]'},
					schema.items))));
	return structCode;
};
...
var Elm = {};
Elm['Lofi'] = Elm['Lofi'] || {};
Elm['Lofi']['Schema'] = Elm['Lofi']['Schema'] || {};
Elm['Lofi']['Schema']['Output'] = Elm['Lofi']['Schema']['Output'] || {};
Elm['Lofi']['Schema']['Output']['ReactProps'] = Elm['Lofi']['Schema']['Output']['ReactProps'] || {};
if (typeof _user$project$Lofi_Schema_Output_ReactProps$main !== 'undefined') {
    _user$project$Lofi_Schema_Output_ReactProps$main(Elm['Lofi']['Schema']['Output']['ReactProps'], 'Lofi.Schema.Output.ReactProps', undefined);
}
